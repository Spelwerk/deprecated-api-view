...
async function get(req, route, model) {
    try {
        let array = [];

        let creatureList = await request.multiple(req, route + '/weapons');
        ...
        for (let i in data) {
            ...
            item.attributes = await request.multiple(req, route + '/weapons/' + item.id + '/attributes/mini');
            item.primals = await request.multiple(req, route + '/weapons/' + item.id + '/primals/mini');
            item.skills = await request.multiple(req, route + '/weapons/' + item.id + '/skills/mini');
            item.mods = await request.multiple(req, route + '/weapons/' + item.id + '/mods');
